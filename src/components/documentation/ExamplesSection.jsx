import { Box, Connector, Valve, ImageBox, Line } from "../DiagramComponents";
        ...
        <div className="mb-8">
          ...
          <div className="relative w-full h-[400px] bg-gray-50 border border-gray-200 rounded-lg p-6 overflow-hidden">
            ...
            <Connector
              ...
              boxes={[
                { id: "pmu", x: 50, y: 50, width: 80, height: 30 },
                { id: "main-processor", x: 200, y: 150, width: 100, height: 60 },
              ]}
            ...
            <Connector
              ...
              boxes={[
                { id: "pmu", x: 50, y: 50, width: 80, height: 30 },
                { id: "gpu", x: 380, y: 40, width: 80, height: 50 },
              ]}
              connectionType="straight"
              className="text-blue-600"
              showArrow={true}
            ...
            <Connector
              ...
              boxes={[
                { id: "memory-controller", x: 50, y: 150, width: 70, height: 40 },
                { id: "main-processor", x: 200, y: 150, width: 100, height: 60 },
              ]}
              connectionType="straight"
              className="text-emerald-600"
            ...
            <Connector
              ...
              boxes={[
                { id: "memory-controller", x: 50, y: 150, width: 70, height: 40 },
                { id: "ddr5-1", x: 30, y: 250, width: 50, height: 25 },
              ]}
              connectionType="orthogonal"
            ...
            <Connector
              ...
              boxes={[
                { id: "memory-controller", x: 50, y: 150, width: 70, height: 40 },
                { id: "ddr5-2", x: 90, y: 250, width: 50, height: 25 },
              ]}
              connectionType="orthogonal"
              className="text-cyan-600"
              showArrow={true}
            ...
            <Connector
              ...
              boxes={[
                { id: "main-processor", x: 200, y: 150, width: 100, height: 60 },
                { id: "pcie-controller", x: 400, y: 150, width: 70, height: 40 },
              ]}
              connectionType="straight"
            ...
            <Connector
              ...
              boxes={[
                { id: "pcie-controller", x: 400, y: 150, width: 70, height: 40 },
                { id: "nvme-1", x: 380, y: 250, width: 60, height: 25 },
              ]}
              connectionType="orthogonal"
            ...
            <Connector
              ...
              boxes={[
                { id: "pcie-controller", x: 400, y: 150, width: 70, height: 40 },
                { id: "nvme-2", x: 450, y: 250, width: 60, height: 25 },
              ]}
              connectionType="orthogonal"
              className="text-indigo-600"
              showArrow={true}
            ...
            <Connector
              ...
              boxes={[
                { id: "main-processor", x: 200, y: 150, width: 100, height: 60 },
                { id: "network-processor", x: 200, y: 300, width: 100, height: 50 },
              ]}
              connectionType="straight"
